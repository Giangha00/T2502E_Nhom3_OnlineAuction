...
public sealed class SetupAuthAdminE2ETests : E2ETestBase
{
    ...
    public void AUTH_01_SignUpValid()
    {
        ...
        Go("/");
        new AuthModalPage(Driver).SignUp("E2E User", email, "09123456789", "User@123", "User@123");
        var confirm = Http.PostForm("/Smoke/ConfirmEmail", [new("email", email)]);
        Assert.True(confirm.IsSuccessStatusCode || E2EAuthHelper.HasUserCookie(Driver));
    }
    ...
    public void AUTH_02_SignUpDuplicateEmail()
    {
        ...
        Assert.True(auth.IsErrorVisible() || auth.IsLoggedInHeader());
    }
    ...
    public void AUTH_06_LogoutPublic()
    {
        ...
        Driver.FindElement(By.Id("userMenuBtn")).Click();
    ...
    public void AUTH_08_PasswordPolicy()
    {
        ...
        Assert.True(new AuthModalPage(Driver).IsErrorVisible());
    }
    ...
    public void ADM_AUTH_05_IndependentLogout()
    {
        ...
        adminDriver.Navigate().GoToUrl(Url("/Admin/Dashboard"));
        Assert.Contains("Login", adminDriver.Url, StringComparison.OrdinalIgnoreCase);
    ...
    public void AUCTION_REG_03_RegisterDepositSmoke()
    {
        ...
        Assert.Contains("auction", pick, StringComparison.OrdinalIgnoreCase);
    ...
    public void BID_01_PlaceBidSmoke()
    {
        ...
        var canPlace = panel.GetAttribute("data-can-place-bid") == "true";
        if (canPlace)
        {
        ...
        Assert.True(canPlace || panel.GetAttribute("data-can-bid") == "true");
    }
}
